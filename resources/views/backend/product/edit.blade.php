...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          <label for="size">Dung tích</label>
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              @foreach($items as $item)
                ...
                // dd($data);
                @endphp
              <option value="750ml"  @if( in_array( "750ml",$data ) ) selected @endif>750ml</option>
              <option value="850ml"  @if( in_array( "850ml",$data ) ) selected @endif>850ml</option>
              <option value="1000ml"  @if( in_array( "1000ml",$data ) ) selected @endif>1000ml</option>
              <option value="1500ml"  @if( in_array( "1500ml",$data ) ) selected @endif>1500ml</option>
              @endforeach
          </select>
        </div>
        <div class="form-group">
